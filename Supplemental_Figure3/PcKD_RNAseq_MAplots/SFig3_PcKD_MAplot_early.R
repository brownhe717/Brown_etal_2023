...
ggmaplot(res_ead_vs_wd_early, fdr = 0.05, fc = 2, size = 0.4, genenames = as.vector(res_ead_vs_wd_early$geneid), top = 2, 
...
# WT EAD v. PcKD EAD
ggmaplot(res_ead_early, fdr = 0.05, fc = 2, size = 0.4, genenames = as.vector(res_ead_early$geneid), top = 2, 
         label.select = c("Antp", "vg", "nub", "ap", "Sox15", "Dr", "Ubx", "ey", "toy", "eya", "Scr"), 
         font.label = c("bold", 11), label.rectangle = TRUE, font.legend = "bold", font.main = "bold", 
         palette = c("steelblue3", "yellowgreen","slategrey"),
         ggtheme = ggplot2::theme_classic(), select.top.method = "padj", ylim = c(-10,10))
...
# WT WD v. PcKD EAD
ggmaplot(res_wd_early, fdr = 0.05, fc = 2, size = 0.4, genenames = as.vector(res_ead_early$geneid), top = 2, 
         label.select = c("Antp", "vg", "nub", "ap", "Sox15", "Dr", "Ubx", "ey", "toy", "eya", "Scr"),
         font.label = c("bold", 11), label.rectangle = TRUE, font.legend = "bold", font.main = "bold", 
         palette = c("steelblue3", "yellowgreen","slategrey"),
         ggtheme = ggplot2::theme_classic(), select.top.method = "padj", ylim = c(-10,10))
